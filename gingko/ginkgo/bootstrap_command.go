...
import (
	...
	"github.com/parallelcointeam/pod/gingko/ginkgo/nodot"
)
...
func generateBootstrap(agouti, noDot, internal bool, customBootstrapFile string) {
	...
	data := bootstrapData{
		...
		GinkgoImport:  `. "github.com/parallelcointeam/pod/gingko"`,
		GomegaImport:  `. "github.com/parallelcointeam/pod/gomega"`,
	}

	if noDot {
		data.GinkgoImport = `"github.com/parallelcointeam/pod/gingko"`
		data.GomegaImport = `"github.com/parallelcointeam/pod/gomega"`
	}
