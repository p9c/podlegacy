...
// NewAmount is for specifically for converting DUO to Satoshi.
// For creating a new Amount with an int64 value which denotes a quantity of Satoshi,
// do a simple type conversion from type int64 to Amount.
// See GoDoc for example: http://godoc.org/github.com/parallelcointeam/pod/btcutil#example-Amount
