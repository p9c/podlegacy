...
var (
	// Algos bits values were generated by running all 9 on a testnet and represent approximately the correct value for mining with 1 core of a Ryzen 5 CPU to avoid fast early blocks when running testnets, and for a live network, should an algorithm fall back to only having one or two CPUs mining it
	Algos = map[string]AlgoParams{
		"sha256d":   AlgoParams{2, 0x1d0189fe, 0},
		"blake14lr": AlgoParams{3, 0x1d1089f6, 2},
		"whirlpool": AlgoParams{6, 0x1d1c0eea, 3},
		"lyra2rev2": AlgoParams{10, 0x1d5c89d1, 4},
		"skein":     AlgoParams{18, 0x1d332839, 5},
		"x11":       AlgoParams{34, 0x1d5c89d1, 6},
		"gost":      AlgoParams{66, 0x1e00b629, 7},
		"keccak":    AlgoParams{130, 0x1e050502, 8},
