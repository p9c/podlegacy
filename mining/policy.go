...
func calcInputValueAge(tx *wire.MsgTx, utxoView *chain.UtxoViewpoint, nextBlockHeight int32) float64 {
...
func CalcPriority(tx *wire.MsgTx, utxoView *chain.UtxoViewpoint, nextBlockHeight int32) float64 {
