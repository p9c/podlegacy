...
reason, the pod suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire pod
...
One of the major design goals of all core pod packages is to aim for complete
...
commits](https://github.com/parallelcointeam/pod/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into pod.
...
[ISC license](https://github.com/parallelcointeam/pod/blob/master/LICENSE).  This is
the same license as all of the code in the pod suite.
