...
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee utils.Amount) int64 {
	...
	if minFee < 0 || minFee > utils.MaxSatoshi {
		minFee = utils.MaxSatoshi
	}
...
func isDust(txOut *wire.TxOut, minRelayTxFee utils.Amount) bool {
...
func checkTransactionStandard(tx *utils.Tx, height int32,
