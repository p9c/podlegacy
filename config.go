...
// config defines the configuration options for pod.
...
// The above results in pod functioning properly without any config settings
...
// podDial connects to the address on the named network using the appropriate
