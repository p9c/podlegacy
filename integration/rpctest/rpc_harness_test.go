...
func testSendOutputs(r *Harness, t *testing.T) {
	genSpend := func(amt btcutil.Amount) *chainhash.Hash {
		...
		// Next, send amt DUO to this address, spending from one of our mature
		// coinbase outputs.
...
func testMemWalletReorg(r *Harness, t *testing.T) {
	...
	// The original wallet should now have a balance of 0 DUO as its entire
...
func testMemWalletLockedOutputs(r *Harness, t *testing.T) {
	...
	// The current wallet balance should now be at least 50 DUO less
