...
function which allows a Log.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/parallelcointeam/pod/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
