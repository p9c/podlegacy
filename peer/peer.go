...
//
// This function is safe for concurrent access.
func (p *Peer) PushGetBlocksMsg(locator chain.BlockLocator, stopHash *chainhash.Hash) error {
...
//
// This function is safe for concurrent access.
func (p *Peer) PushGetHeadersMsg(locator chain.BlockLocator, stopHash *chainhash.Hash) error {
	// Extract the begin hash from the block locator, if one was specified,
