...
func WatchAddrs(watchAddrs ...utils.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func (s *ChainService) extractBlockMatches(ro *rescanOptions,
	curStamp *waddrmgr.BlockStamp) ([]*utils.Tx, error) {
	...
	relevantTxs := make([]*utils.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *utils.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *utils.Tx) (bool, error) {
...
func AddAddrs(addrs ...utils.Address) UpdateOption {
