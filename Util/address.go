...
import (
	...
	"github.com/parallelcointeam/pod/Util/base58"
	"github.com/parallelcointeam/pod/Util/bech32"
...
func NewAddressPubKey(serializedPubKey []byte, net *chaincfg.Params) (*AddressPubKey, error) {
	pubKey, err := ecc.ParsePubKey(serializedPubKey, ecc.S256())
	if err != nil {
		return nil, err
	}

	// Set the format of the pubkey.  This probably should be returned
	// from ecc, but do it here to avoid API churn.  We already know the
