...
[![Coverage Status](http://img.shields.io/coveralls/btcsuite/utils.svg)](https://coveralls.io/r/btcsuite/utils?branch=master)
[![ISC License](http://img.shields.io/badge/license-ISC-blue.svg)](http://copyfree.org)
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/btcsuite/utils)
...
```bash
$ go get -u github.com/btcsuite/utils
```
...
Package utils is licensed under the [copyfree](http://copyfree.org) ISC
License.
