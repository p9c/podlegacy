...
// Tx returns a wrapped transaction (utils.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (utils.Tx) for all
...
// instead provides easy access to wrapped versions (utils.Tx) of them.
