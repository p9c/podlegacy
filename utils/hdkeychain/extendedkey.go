...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := utils.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*utils.AddressPubKeyHash, error) {
	pkHash := utils.Hash160(k.pubKeyBytes())
	return utils.NewAddressPubKeyHash(pkHash, net)
}
