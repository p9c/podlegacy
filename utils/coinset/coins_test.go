...
import (
	...
	"github.com/parallelcointeam/pod/utils/coinset"
...
func NewCoin(index int64, value utils.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = utils.Amount(3500000)
	...
	testSimpleCoinTx, _               = utils.NewTxFromBytes(testSimpleCoinTxBytes)
