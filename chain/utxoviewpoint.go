...
func (view *UtxoViewpoint) AddTxOut(tx *utils.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *utils.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *utils.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *utils.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *utils.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *utils.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *utils.Tx) (*UtxoViewpoint, error) {
