...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/parallelcointeam/pod/chain/fullblocktests)
...
```bash
$ go get -u github.com/parallelcointeam/pod/chain/fullblocktests
```
