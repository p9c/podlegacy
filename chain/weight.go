...
func GetBlockWeight(blk *utils.Block) int64 {
...
func GetTransactionWeight(tx *utils.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *utils.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
