...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []utils.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []utils.Address) ([]JSON.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee utils.Amount) FutureSetTxFeeResult {
	cmd := JSON.NewSetTxFeeCmd(fee.ToBTC())
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee utils.Amount) error {
...
func (c *Client) SendToAddressAsync(address utils.Address, amount utils.Amount) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := JSON.NewSendToAddressCmd(addr, amount.ToBTC(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address utils.Address, amount utils.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address utils.Address,
	amount utils.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := JSON.NewSendToAddressCmd(addr, amount.ToBTC(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address utils.Address, amount utils.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress utils.Address, amount utils.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := JSON.NewSendFromCmd(fromAccount, addr, amount.ToBTC(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress utils.Address, amount utils.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress utils.Address, amount utils.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := JSON.NewSendFromCmd(fromAccount, addr, amount.ToBTC(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress utils.Address, amount utils.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress utils.Address, amount utils.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress utils.Address,
	amount utils.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[utils.Address]utils.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[utils.Address]utils.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[utils.Address]utils.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[utils.Address]utils.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (utils.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return utils.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []utils.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []utils.Address, account string) (utils.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []utils.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []utils.Address) (*JSON.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (utils.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (utils.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (utils.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (utils.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (utils.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (utils.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (utils.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (utils.Address, error) {
...
func (c *Client) GetAccountAsync(address utils.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address utils.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address utils.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address utils.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]utils.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]utils.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := utils.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]utils.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount utils.Amount) FutureMoveResult {
	cmd := JSON.NewMoveCmd(fromAccount, toAccount, amount.ToBTC(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount utils.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount utils.Amount, minConfirms int) FutureMoveResult {

	cmd := JSON.NewMoveCmd(fromAccount, toAccount, amount.ToBTC(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount utils.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount utils.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount utils.Amount,
...
func (c *Client) ValidateAddressAsync(address utils.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address utils.Address) (*JSON.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]utils.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]utils.Amount)
	for k, v := range accounts {
		amount, err := utils.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]utils.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]utils.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (utils.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := utils.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (utils.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (utils.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (utils.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (utils.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (utils.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (utils.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (utils.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (utils.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (utils.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address utils.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address utils.Address) (utils.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address utils.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address utils.Address, minConfirms int) (utils.Amount, error) {
...
func (c *Client) SignMessageAsync(address utils.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address utils.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address utils.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address utils.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*utils.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return utils.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address utils.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address utils.Address) (*utils.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *utils.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *utils.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *utils.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *utils.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *utils.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *utils.WIF, label string, rescan bool) error {
