...
func (r FutureGetRawTransactionResult) Receive() (*utils.Tx, error) {
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*utils.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []JSON.TransactionInput,
	amounts map[utils.Address]utils.Amount, lockTime *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []JSON.TransactionInput,
	amounts map[utils.Address]utils.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address utils.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address utils.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address utils.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address utils.Address, skip,
