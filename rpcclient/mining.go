...
func (c *Client) SubmitBlockAsync(block *btcutil.Block, options *JSON.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *btcutil.Block, options *JSON.SubmitBlockOptions) error {
