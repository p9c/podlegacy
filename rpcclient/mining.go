...
func (c *Client) SubmitBlockAsync(block *utils.Block, options *JSON.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *utils.Block, options *JSON.SubmitBlockOptions) error {
