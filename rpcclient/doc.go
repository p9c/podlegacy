...
API.  This client has been tested with btcd (https://github.com/parallelcointeam/pod),
btcwallet (https://github.com/parallelcointeam/pod), and
...
detected by type asserting the error in a *JSON.RPCError.  For example, to
detect if a command is unimplemented by the remote RPC server:

  amount, err := client.GetBalance("")
  if err != nil {
  	if jerr, ok := err.(*JSON.RPCError); ok {
  		switch jerr.Code {
  		case JSON.ErrRPCUnimplemented:
