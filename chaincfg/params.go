...
var (
	...
	// have for the main network.  It is the maximum target / 2^20
	mainPowLimit = allOnes.Rsh(&allOnes, 20)
	...
	// can have for the test network (version 3).  It is the maximum target / 2^20
	testNet3PowLimit = allOnes.Rsh(&allOnes, 20)
