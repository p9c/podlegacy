...
// list of commands that we recognize, but for which pod has no support because
...
// This function returns more information than parallelcoind.
...
// This command does not default to the same end block as the parallelcoind
